...
'environment' = this folder was used to host my virtual environment. I recommend you use this folder as
                ...
                virtual environemnt. Located in this folder is also a file called 'WebScraper8.py'. This is the file that is my current version of my scraper. This is the file you should run to access my scraper.
